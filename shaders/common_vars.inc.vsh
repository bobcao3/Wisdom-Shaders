...
void calcCommon() {
	...
	vec3 skycolor_noon = vec3(0.45, 0.61, 1.0) * 0.9 * (1.0-rainStrength*1.0) * TimeNoon;
	...
	vec3 horizontColor_night = vec3(0.3, 0.7, 1.3) * 0.02 * (1.0-rainStrength*1.0) * TimeMidnight;
